 ...
 */
final class Version20211120110455 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_likes DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE post_likes ADD user_mail VARCHAR(255) NOT NULL, DROP user_id');
        $this->addSql('ALTER TABLE post_likes ADD CONSTRAINT FK_DED1C2922BA7E081 FOREIGN KEY (user_mail) REFERENCES user (mail)');
        $this->addSql('CREATE INDEX IDX_DED1C2922BA7E081 ON post_likes (user_mail)');
        $this->addSql('ALTER TABLE post_likes ADD PRIMARY KEY (post_id, user_mail)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE post_likes DROP FOREIGN KEY FK_DED1C2922BA7E081');
        $this->addSql('DROP INDEX IDX_DED1C2922BA7E081 ON post_likes');
        $this->addSql('ALTER TABLE post_likes DROP PRIMARY KEY');
        $this->addSql('ALTER TABLE post_likes ADD user_id INT NOT NULL, DROP user_mail');
        ...
        $this->addSql('ALTER TABLE post_likes ADD PRIMARY KEY (post_id, user_id)');
