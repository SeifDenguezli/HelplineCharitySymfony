 ...
 */
final class Version20211120201738 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comments_likes (comment_id INT NOT NULL, user_id INT NOT NULL, INDEX IDX_1FCA91BF8697D13 (comment_id), INDEX IDX_1FCA91BA76ED395 (user_id), PRIMARY KEY(comment_id, user_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE comments_likes ADD CONSTRAINT FK_1FCA91BF8697D13 FOREIGN KEY (comment_id) REFERENCES comments (commentId)');
        $this->addSql('ALTER TABLE comments_likes ADD CONSTRAINT FK_1FCA91BA76ED395 FOREIGN KEY (user_id) REFERENCES user (userId)');
