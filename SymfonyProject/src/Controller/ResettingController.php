...
class ResettingController extends Controller
{
    ...
    public function request(Request $request, Mailer $mailer, TokenGeneratorInterface $tokenGenerator)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $user = $em->getRepository(User::class)->findOneByMail($form->getData()['email']);
            ...
            $mailer->sendMessage('helplinecharityconfirm@gmail.com', $user->getMail(), 'renouvellement du mot de passe', $bodyMail);
